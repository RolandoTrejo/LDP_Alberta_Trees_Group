...
author: "Rolando Trejo (Université de Montréal),Jhoan Chavez (University of Northern British Columbia) ,Zihaohan Sang (University of Alberta)"
...
![](~/Documents/GitHub/LDP_Alberta_Trees_Group/Biodiversity_Rings_Alberta/Vascular_Plants.png)
...
![](~/Documents/GitHub/LDP_Alberta_Trees_Group/Alberta_Project.png)
  </details>
...
![](~/Documents/GitHub/LDP_Alberta_Trees_Group/Location.png)
  </details>
...
Hondo_VascularCover_2010_CLEAN<-read.csv("~/Documents/GitHub/LDP_Alberta_Trees_Group/Hondo_VascularCover_2010_CLEAN.csv", sep=";")
Hondo_SoilTemp_2010_CLEAN<- read.csv("~/Documents/GitHub/LDP_Alberta_Trees_Group/Hondo_SoilTemp_2010_CLEAN.csv", sep=";")
...
```{r AOS_plot, exercise=TRUE, exercise.lines = 25, message=FALSE}
library(tidyverse)
library(readr)
library(dplyr)
library(ggplot2)
...
aos_files <- list.files(path = '/Users/rolandotrejoperez/Documents/GitHub/LDP_Alberta_Trees_Group',
...
<details>
  <summary> **Click here** </summary>
  <p>  
```{r Hondo_plot, exercise=TRUE, exercise.lines = 25, message=FALSE}

## same for HONDO
#n=1, 2, 3 stands
hondo_files <- list.files(path = '/Users/rolandotrejoperez/Documents/GitHub/LDP_Alberta_Trees_Group',
