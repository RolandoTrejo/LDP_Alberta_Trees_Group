...
**12.1. SPECIES RICHNESS AS A FUNCTION OF SOIL TEMPERATURE (°C)**
...
**12.3.1. Species richness as a function of soil temperature (°C) plus stand, and soil temperature-stand interaction**
...
**12.3.2. Species richness as a function of soil temperature (°C) plus stand, and soil temperature-stand interaction**
...
**12.3.3. Species richness as a function of soil temperature (°C) and stand**
...
```
  ...
  This tutorial was created using RStudio and RMarkdown. The entire code to reproduce the results and graphics provided in this tutorial is available in the Living Data Working Group project through the GitHub page.
